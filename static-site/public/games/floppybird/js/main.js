...
function showSplash()
{
   ...
   //fade in the splash
   $("#splash").transition({ opacity: 1 }, 500, 'ease');
}
...
function screenClick()
{
   ...
   else if(currentstate == states.ReviveScreen)
   {
      resumeGame();
   }
}
...
function showScore()
{
   ...
   $("#scoreboard").transition({ y: '0px', opacity: 1}, 250, 'ease', function() {
      //When the animation is done, animate in the replay button
      $("#replay").transition({ y: '0px', opacity: 1}, 250, 'ease');
