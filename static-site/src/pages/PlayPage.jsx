    ...
    return (
      <div className="flex flex-col h-[100dvh] w-full bg-black overflow-hidden relative">
        <div className="flex flex-col items-center justify-center h-full text-white/50">
          <p className="mb-4">{t('play.invalidUrl')}</p>
        ...
        <iframe
          srcDoc={`
            ...
            <body>
                ...
                <script data-cfasync="false" type="text/javascript" src="//www.highperformanceformat.com/a7d763a29934a2cb86e8b7b822a3f2f1/invoke.js"></script>
            </body>
            </html>
          `}
