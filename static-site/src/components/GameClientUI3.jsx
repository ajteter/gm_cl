...
/**
 * GameClientUI3 component for displaying games in fullscreen mode with Game3 specific ad configuration
 * Handles URL parameter forwarding for ad attribution and provides game embedding
 */
export default function GameClientUI3({ 
  game, 
  title = "1 DAY 1 GAME", 
  showTitle = true,
  adConfig,
  ...
  // Default ad configuration for Game3 - same as Game1 but with different keys
  const defaultAdConfig = {
    key: 'GAME3_DEFAULT_AD_KEY_PLACEHOLDER',
    height: 50,
    width: 320,
    maxHeight: '100px',
    script: '//GAME3_DEFAULT_AD_SCRIPT_URL_PLACEHOLDER/invoke.js',
    delay: 1000
  }
